...
<body>
	...
	<div class="container">
    	<div class="card text-left">
			<div class="card-header"><center>Comparar Huella Con otra</center></div>
			<div class="card-body">
				<!--INICIO-->
				<form>
                    <div class="form-row">
                        <div class="form-group col-md-12">
							<label for="selectHuella">Selecionar Huella</label>
							<select id="selectHuella" class="form-control">
								  <option value="0" selected>Seleccionar Huella</option>
	                        </select>
						</div>
                    </div>
					<div class="form-row">
                    ...
                    <div class="form-row">
						...
						<div class="form-group col-md-6">
                            ...
                            <input type="hidden" class="form-control" id="idHuellaOriginal" placeholder="MYDBA" disabled>
						</div>
					</div>
...
<script src="../js/compareFootprintOther.js"></script> 
</html>
<?php
} else {
	header("location:../");
