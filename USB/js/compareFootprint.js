$(function(){
    ...
    //TRAER HUELLA
    var parameters = {'object':'footPrint','method':'compareFootprintSystem','parameters':arrData};
    $.ajax({
        ...
        success:function(data)
        {
            ...
            {   
               ...
               $("#strIp").val(parsed.data.IP);
               $("#strDbaName").val(parsed.data.NAME);
               $("#strUser").val(parsed.data.USER);
               $("#strPassword").val(parsed.data.PASSWORDDB); 
               //PINTAR VERSIONES
